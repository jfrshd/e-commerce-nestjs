...
exports.JwtIncludeDeletedStrategy = void 0;
const common_1 = require("@nestjs/common");
const passport_1 = require("@nestjs/passport");
const passport_jwt_1 = require("passport-jwt");
const config_1 = require("@nestjs/config");
const auth_service_1 = require("../auth.service");
let JwtIncludeDeletedStrategy = class JwtIncludeDeletedStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy, 'jwt-include-deleted') {
...
exports.JwtIncludeDeletedStrategy = JwtIncludeDeletedStrategy;
exports.JwtIncludeDeletedStrategy = JwtIncludeDeletedStrategy = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [auth_service_1.AuthService,
        config_1.ConfigService])
], JwtIncludeDeletedStrategy);
//# sourceMappingURL=jwt-include-deleted.strategy.js.map